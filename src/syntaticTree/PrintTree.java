...
public class PrintTree {
    ...
    /**** Constante de assignment default ****/
    ...
    /**** Constante boolean ****/
    public void numberBoolConstNode(BoolConstNode x) {
        if(x == null) return;
    ...
    public void printBoolConstNode(BoolConstNode x) {
        ...
        System.out.println(x.number + ": BoolConstNode ===> " + x.position.image);
    }
    ...
    public void printIndexNode(IndexNode x) {
        ...
        System.out.println(x.number + ": IndexNode ===> " + x.expre1.number + " " +
            x.expre2.number);
        printExpreNode(x.expre1);
        printExpreNode(x.expre2);
    }
    ...
    public void numberExpreNode(ExpreNode x) {
        if (x instanceof NewObjectNode) {
            ...
            numberAssignConstNode((AssignConstNode) x);
        } else if (x instanceof NullConstNode) {
            numberNullConstNode((NullConstNode) x);
        } else if (x instanceof BoolConstNode) {
            numberBoolConstNode((BoolConstNode) x);
        } else if (x instanceof CharConstNode) {
